...
def train_with_triplet_loss(epochs=EPOCHS, batch_size=1):
    ...
    with open(f"{RESULTS_DIRECTORY}/information.txt", "w") as file:
        ...
        # file.write("\n")
        file.write(f"Query is Touch. Vision+Audio as Retrieval. Classifiaction with joint embd. Training with margin {MARGIN} and {epochs} epochs, and batch size {batch_size}.")
